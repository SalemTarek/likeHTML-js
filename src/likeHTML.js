var as = document.querySelectorAll('a'),
    ...
    abbrs = document.querySelectorAll('abbr'),
    abbr = document.querySelector('abbr'),
    addresss = document.querySelectorAll('address'),
    ...
    bs = document.querySelectorAll('b'),
    b = document.querySelector('b'),
    bases = document.querySelectorAll('base'),
    base = document.querySelector('base'),
    bdis = document.querySelectorAll('bdi'),
    bdi = document.querySelector('bdi'),
    bdos = document.querySelectorAll('bdo'),
    bdo = document.querySelector('bdo'),
    ...
    cites = document.querySelectorAll('cite'),
    ...
    h5s = document.querySelectorAll('h5'),
    h5 = document.querySelector('h5'),
    h6s = document.querySelectorAll('h5'),
    h6 = document.querySelector('h5'),
    ...
    inss = document.querySelectorAll('ins'),
    ins = document.querySelector('ins'),
    kbds = document.querySelectorAll('kbd'),
    kbd = document.querySelector('kbd'),
    keygens = document.querySelectorAll('keygen'),
    keygen = document.querySelector('keygen'),
    labels = document.querySelectorAll('label'),
    label = document.querySelector('label'),
    lengends = document.querySelectorAll('lengend'),
    lengend = document.querySelector('lengend'),
    ...
    optgroups = document.querySelectorAll('optgroup'),
    optgroup = document.querySelector('optgroup'),
    ...
    params = document.querySelectorAll('param'),
    param = document.querySelector('param'),
    pres = document.querySelectorAll('pre'),
    pre = document.querySelector('pre'),
    progresss = document.querySelectorAll('progress'),
    ...
    summarys = document.querySelectorAll('summary'),
    ...
    tfoots = document.querySelectorAll('tfoot'),
